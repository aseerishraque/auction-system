						...
						<ul class="flex items-center flex-shrink-0 space-x-6">
							...
							<li class="relative" @click="isProfileMenuOpen = !isProfileMenuOpen" ref="profileMenu">
								<button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none" aria-label="Account" aria-haspopup="true">
									<img class="object-cover w-8 h-8 rounded-full" src="https://images.unsplash.com/photo-1627610492557-a0e06995dda5?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80" alt="User" aria-hidden="true" lazy-load="true"/>
								</button>
